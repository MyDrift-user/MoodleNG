...
export class ApiExplorerService {
  ...
  private knownEndpoints: ApiEndpoint[] = [
    // Course API Endpoints
    {
      ...
      parameters: [
        { name: 'userid', type: 'number', description: 'User ID (defaults to current user)', required: true, defaultValue: '' }
      ],
      category: 'course'
    },
    {
      ...
      parameters: [
        { name: 'courseid', type: 'number', description: 'Course ID', required: true, defaultValue: '' }
      ],
      category: 'course'
    },
    {
      ...
      parameters: [
        { name: 'options[ids]', type: 'string', description: 'List of course IDs separated by commas', required: true, defaultValue: '' }
      ],
      category: 'course'
    },
    {
      ...
      parameters: [
        { name: 'field', type: 'string', description: 'Field to search by', required: true, defaultValue: 'id' },
        { name: 'value', type: 'string', description: 'Value to match', required: true, defaultValue: '' }
      ],
      category: 'course'
    },
    ...
    },
    {
      ...
      parameters: [
        { name: 'cmid', type: 'number', description: 'Course module ID', required: true, defaultValue: '' },
        { name: 'areaname', type: 'string', description: 'Grading area name', required: true, defaultValue: 'submission' }
      ],
      category: 'grades'
    },
    ...
    },
    {
      ...
      parameters: [
        { name: 'field', type: 'string', description: 'Field to search by (id, username, email)', required: true, defaultValue: 'id' },
        { name: 'values[]', type: 'string', description: 'Field values to match, separated by commas', required: true, defaultValue: '' }
      ],
      category: 'user'
    },
    {
      ...
      parameters: [
        { name: 'userid', type: 'number', description: 'User ID (defaults to current user)', required: false, defaultValue: '' },
        { name: 'name', type: 'string', description: 'Preference name', required: false, defaultValue: '' }
      ],
      category: 'user'
    },
    ...
    // Calendar API Endpoints
    {
      ...
      parameters: [
        { name: 'events[courseids][]', type: 'string', description: 'Course IDs separated by commas', required: false, defaultValue: '' },
        { name: 'events[eventids][]', type: 'string', description: 'Event IDs separated by commas', required: false, defaultValue: '' },
        { name: 'options[timestart]', type: 'number', description: 'Time start timestamp', required: false, defaultValue: '' },
        { name: 'options[timeend]', type: 'number', description: 'Time end timestamp', required: false, defaultValue: '' }
      ],
      category: 'calendar'
    },
    {
      ...
      parameters: [
        { name: 'courseid', type: 'number', description: 'Course ID', required: true, defaultValue: '' },
        { name: 'timesortfrom', type: 'number', description: 'Start time timestamp', required: false, defaultValue: '' },
        { name: 'timesortto', type: 'number', description: 'End time timestamp', required: false, defaultValue: '' },
        { name: 'limitnum', type: 'number', description: 'Maximum number of results to return', required: false, defaultValue: '20' }
      ],
      category: 'calendar'
    },
    ...
    // File API Endpoints
    {
      ...
      parameters: [
        { name: 'contextid', type: 'number', description: 'Context ID', required: true, defaultValue: '' },
        { name: 'component', type: 'string', description: 'Component', required: true, defaultValue: 'user' },
        { name: 'filearea', type: 'string', description: 'File area', required: true, defaultValue: 'private' },
        { name: 'itemid', type: 'number', description: 'Item ID', required: true, defaultValue: '0' },
        { name: 'filepath', type: 'string', description: 'File path', required: true, defaultValue: '/' },
        { name: 'filename', type: 'string', description: 'File name', required: true, defaultValue: '' }
      ],
      category: 'files'
    },
    ...
    // Forum API Endpoints
    {
      ...
      parameters: [
        { name: 'forumid', type: 'number', description: 'Forum ID', required: true, defaultValue: '' },
        { name: 'sortby', type: 'string', description: 'Sort order (id, timemodified, timestart, timeend)', required: false, defaultValue: 'timemodified' },
        { name: 'sortdirection', type: 'string', description: 'Sort direction (ASC or DESC)', required: false, defaultValue: 'DESC' },
        { name: 'page', type: 'number', description: 'Page number', required: false, defaultValue: '0' },
        { name: 'perpage', type: 'number', description: 'Items per page', required: false, defaultValue: '10' }
      ],
      category: 'forum'
    },
    {
      ...
      parameters: [
        { name: 'discussionid', type: 'number', description: 'Discussion ID', required: true, defaultValue: '' },
        { name: 'sortby', type: 'string', description: 'Sort by (id, created, modified)', required: false, defaultValue: 'created' },
        { name: 'sortdirection', type: 'string', description: 'Sort direction (ASC or DESC)', required: false, defaultValue: 'ASC' }
      ],
      category: 'forum'
    },
    ...
    // Assignment API Endpoints
    {
      ...
      parameters: [
        { name: 'courseids[]', type: 'string', description: 'Course IDs separated by commas', required: false, defaultValue: '' },
        { name: 'capabilities[]', type: 'string', description: 'Capabilities to check (mod/assign:grade, mod/assign:submit)', required: false, defaultValue: '' }
      ],
      category: 'assignment'
    },
    {
      ...
      parameters: [
        { name: 'assignid', type: 'number', description: 'Assignment ID', required: true, defaultValue: '' },
        { name: 'userid', type: 'number', description: 'User ID', required: false, defaultValue: '' }
      ],
      category: 'assignment'
    },
    ...
    },
    {
      ...
      parameters: [
        { name: 'quizid', type: 'number', description: 'Quiz ID', required: true, defaultValue: '' },
        { name: 'userid', type: 'number', description: 'User ID', required: false, defaultValue: '' },
        { name: 'status', type: 'string', description: 'Status (all, finished, unfinished)', required: false, defaultValue: 'all' }
      ],
      category: 'quiz'
    },
    ...
    },
    {
      ...
      parameters: [
        { name: 'userid', type: 'number', description: 'User ID', required: true, defaultValue: '' }
      ],
      category: 'competency'
    },
    ...
    // Message API Endpoints
    {
      ...
      parameters: [
        { name: 'useridto', type: 'number', description: 'User ID to (recipient)', required: true, defaultValue: '' },
        { name: 'useridfrom', type: 'number', description: 'User ID from (sender)', required: false, defaultValue: '' },
        { name: 'type', type: 'string', description: 'Type (notifications, conversations, both)', required: false, defaultValue: 'both' },
        { name: 'read', type: 'number', description: 'Read status (0, 1, or empty for any)', required: false, defaultValue: '' },
        { name: 'newestfirst', type: 'number', description: 'Sort newest first (0, 1)', required: false, defaultValue: '1' },
        { name: 'limitfrom', type: 'number', description: 'Limit from', required: false, defaultValue: '0' },
        { name: 'limitnum', type: 'number', description: 'Limit number', required: false, defaultValue: '100' }
      ],
      category: 'message'
    }
  ];

  constructor(private http: HttpClient, private moodleService: MoodleService) {
